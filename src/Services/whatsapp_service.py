...
from src.dtos.whatsapp_dto import MensagemCreate
...
class WhatsappService:
    ...
    async def get_mensagens(self, transportadora_id: UUID, motorista_id: Optional[UUID] = None) -> List[MensagemChat]:
        """
    ...
    async def send_mensagem(self, data: MensagemCreate, transportadora_id: UUID) -> List[MensagemChat]:
        """
        ...
        **RodovIA** ('SISTEMA_IA') responderá de forma automatizada simulando inteligência artificial.
        ...
        await PessoasService.get_motorista_joined(self.session, data.motorista_id, transportadora_id)
